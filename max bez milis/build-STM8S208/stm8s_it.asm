...
;	Reset bit 6 of reg CC. Hardware bug workaround.
	div	x, a
;	./src/stm8s_it.c: 274: TIM2_ClearFlag(TIM2_FLAG_UPDATE);
; genSend
	clrw	x
	incw	x
; genCall
	call	_TIM2_ClearFlag
;	./src/stm8s_it.c: 275: vlastni_cas++;
; genPlus
	ldw	x, _vlastni_cas+2
	addw	x, #0x0001
	ldw	y, _vlastni_cas+0
	jrnc	00103$
	incw	y
00103$:
; genAssign
	ldw	_vlastni_cas+2, x
	ldw	_vlastni_cas+0, y
; genLabel
00101$:
;	./src/stm8s_it.c: 279: }
; genEndFunction
	iret
;	./src/stm8s_it.c: 287: INTERRUPT_HANDLER(TIM2_CAP_COM_IRQHandler, 14)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 302: INTERRUPT_HANDLER(TIM3_UPD_OVF_BRK_IRQHandler, 15)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 314: INTERRUPT_HANDLER(TIM3_CAP_COM_IRQHandler, 16)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 329: INTERRUPT_HANDLER(UART1_TX_IRQHandler, 17)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 341: INTERRUPT_HANDLER(UART1_RX_IRQHandler, 18)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 354: INTERRUPT_HANDLER(I2C_IRQHandler, 19)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 393: INTERRUPT_HANDLER(UART3_TX_IRQHandler, 20)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 405: INTERRUPT_HANDLER(UART3_RX_IRQHandler, 21)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 419: INTERRUPT_HANDLER(ADC2_IRQHandler, 22)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 476: INTERRUPT_HANDLER(TIM4_UPD_OVF_IRQHandler, 23)
; genLabel
;	-----------------------------------------
...
;	Reset bit 6 of reg CC. Hardware bug workaround.
	div	x, a
;	./src/stm8s_it.c: 478: TIM4_ClearFlag(TIM4_FLAG_UPDATE);
; genSend
	ld	a, #0x01
; genCall
	call	_TIM4_ClearFlag
;	./src/stm8s_it.c: 479: miliseconds++;
; genAssign
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 488: INTERRUPT_HANDLER(EEPROM_EEC_IRQHandler, 24)
; genLabel
;	-----------------------------------------
